...
// FETCH API: Effettua una richiesta API per ottenere le serie TV trasmesse oggi e aggiunge le relative card alla galleria.
fetch(`${BASE_URL}/${TYPE}/on_the_air?api_key=${API_TOKEN}`)
.then((res) => res.json())
.then((data) => {
